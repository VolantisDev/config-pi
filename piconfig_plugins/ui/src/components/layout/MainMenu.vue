<template>
  <v-list>
    <v-list-group v-for="item in items" :value="item.active" v-bind:key="item.title">
      <v-list-tile slot="item" :router="true" :href="item.route && !item.items ? item.route : null" ripple>
        <v-list-tile-action>
      ...
      <v-list-item v-for="subItem in item.items" v-bind:key="subItem.title">
        <v-list-tile :router="true" :href="subItem.route ? subItem.route : null" ripple>
          <v-list-tile-content>
